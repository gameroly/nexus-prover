...
```bash
curl -sSL https://raw.githubusercontent.com/gameroly/nexus-prover/main/nexus.sh | bash
```
- Or this command to run this script
```bash
wget -qO - https://raw.githubusercontent.com/gameroly/nexus-prover/main/nexus.sh | bash
```
